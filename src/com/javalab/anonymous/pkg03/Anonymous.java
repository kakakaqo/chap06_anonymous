...
public class Anonymous {
	...
	public Person person = new Person() { // 익명 자식객체 생성
		// 자식이 추가한 메소드
		public void walk() {
			System.out.println("산책합니다.");
		}
		
		// 이클립스 자동 생성 기능으로 구현할것.
		@Override
		public void wake() {
	...
	public void method1() {
		...
		Person localVal = new Person() { // 익명 자식객체 생성
		...
		// 바로 위에서 정의한 익명 객체의 wake()메소드 호출
		localVal.wake(); // 자식이 오버라이딩한 메소드 호출된다.
		// localVal.work(); // 부모에 없는 메소드
	} // end mothod1()
